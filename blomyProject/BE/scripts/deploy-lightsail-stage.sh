...
CERTIFICATE_NAME="${CERTIFICATE_NAME:-vyla-stage-api-cert}"
STAGE_DOMAIN="${STAGE_DOMAIN:-stage.api.vyla.health}"
...
merged = {
    ...
    "PHORA_GOOGLE_HEALTH_CLIENT_ID": existing.get("PHORA_GOOGLE_HEALTH_CLIENT_ID", ""),
    "PHORA_GOOGLE_HEALTH_CLIENT_SECRET": existing.get("PHORA_GOOGLE_HEALTH_CLIENT_SECRET", ""),
    "PHORA_GOOGLE_HEALTH_REDIRECT_URI": existing.get("PHORA_GOOGLE_HEALTH_REDIRECT_URI", ""),
    "PHORA_GOOGLE_HEALTH_OAUTH_SUCCESS_REDIRECT": existing.get("PHORA_GOOGLE_HEALTH_OAUTH_SUCCESS_REDIRECT", "vyla://wearables/google-health?status=connected"),
    "PHORA_GOOGLE_HEALTH_OAUTH_ERROR_REDIRECT": existing.get("PHORA_GOOGLE_HEALTH_OAUTH_ERROR_REDIRECT", "vyla://wearables/google-health?status=error"),
    "AWS_ACCESS_KEY_ID": existing.get("AWS_ACCESS_KEY_ID", ""),
    "AWS_SECRET_ACCESS_KEY": existing.get("AWS_SECRET_ACCESS_KEY", ""),
    "AWS_DEFAULT_REGION": existing.get("AWS_DEFAULT_REGION", "eu-west-2"),
    "PHORA_ANDROID_RELEASE_BUCKET": existing.get("PHORA_ANDROID_RELEASE_BUCKET", ""),
    "PHORA_ANDROID_RELEASE_MANIFEST_KEY": existing.get("PHORA_ANDROID_RELEASE_MANIFEST_KEY", "android/latest.json"),
    "PHORA_ANDROID_RELEASE_PRESIGN_EXPIRATION_SECONDS": existing.get("PHORA_ANDROID_RELEASE_PRESIGN_EXPIRATION_SECONDS", "3600"),
    "PHORA_ANDROID_DOWNLOAD_URL": existing.get("PHORA_ANDROID_DOWNLOAD_URL", ""),
...
env = {
    ...
    "PHORA_ANDROID_RELEASE_BUCKET": os.environ.get("ANDROID_RELEASE_BUCKET", ""),
    "PHORA_ANDROID_RELEASE_MANIFEST_KEY": os.environ.get("ANDROID_RELEASE_MANIFEST_KEY", "android/latest.json"),
    "PHORA_ANDROID_RELEASE_PRESIGN_EXPIRATION_SECONDS": os.environ.get("ANDROID_RELEASE_PRESIGN_EXPIRATION_SECONDS", "3600"),
    "PHORA_ANDROID_DOWNLOAD_URL": os.environ.get("ANDROID_DOWNLOAD_URL", ""),
    "PHORA_FIREBASE_PROJECT_ID": "vyla-41e3a",
    "PHORA_SMTP_ENABLED": "true",
    "PHORA_AFRICA_FREE_LAUNCH_ENABLED": "true",
    "PHORA_LOCAL_CURRENCY_PRICING_ENABLED": "true",
    "PHORA_DEFAULT_PRICING_COUNTRY": "GB",
    "PHORA_DEFAULT_CURRENCY": "GBP",
}
