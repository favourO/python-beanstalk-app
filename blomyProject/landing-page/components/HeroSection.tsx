...
export default function HeroSection() {
  return (
    <section id="hero" className="relative min-h-screen bg-[#FFF6F0] overflow-hidden pt-16">
        ...
        <div className="flex-1 max-w-[560px]">
          ...
          >
            <motion.span
              ...
              animate={{ backgroundColor: ["#C0392B", "#E8A135", "#3BAC6A", "#8E6BBF", "#C0392B"] }}
          ...
          >
            Vyla helps you track periods, symptoms, moods, fertility signs, and daily patterns in one calm place. Get useful predictions and AI-supported explanations based on what you log, so you can understand your body without turning every change into a medical concern.
          </motion.p>
          ...
          >
            ...
            <a
              href="#"
              className="flex items-center gap-3 bg-[#1E0C16] text-white px-5 h-[59px] rounded-[14px] hover:bg-[#2e1a26] transition-colors min-w-[168px]"
            >
              <AppleIcon />
              <div>
            ...
            <a
              href="#"
              className="flex items-center gap-3 bg-white text-[#1E0C16] border border-[#FFE5D6] px-5 h-[59px] rounded-[14px] hover:bg-[#FFF6F0] transition-colors min-w-[176px]"
            >
              <GooglePlayIcon />
              <div>
          ...
          >
            <span className="text-[13px] font-medium text-[#A06A52]">Free to start</span>
          </motion.div>
        </div>
