    ...
    >
      <div className="max-w-[1200px] mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center" aria-label="Vyla home">
          <Image src="https://vyla.health/assets/vyla-logo.png" alt="Vyla" width={1536} height={1024} className="h-26 w-auto block" unoptimized priority />
        </Link>
      ...
      {mobileOpen && (
        ...
        >
          ...
          <div className="pt-2">
            <a href="#download" className="text-sm font-medium bg-[#FF7A33] text-white px-4 py-2 rounded-full" onClick={() => setMobileOpen(false)}>
              Download free
            </a>
          </div>
        </motion.div>
